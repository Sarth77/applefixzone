    ...
    <>
      <section className="px-0 py-[20px] w-full">
        <div className="max-w-[90%] m-auto flex justify-between items-center gap-x-4">
          ...
          <div className="icon flex items-center text-xl justify-end">
            <div className="flex items-center gap-x-6">
              <Link to="/login">
                <div className="bg-[#f6f9fc] h-10 w-10 rounded-full flex justify-center items-center drop-shadow-md hover:scale-110 cursor-pointer">
              ...
              <div className="bg-[#f6f9fc] h-10 w-10 rounded-full flex justify-center items-center drop-shadow-md hover:scale-110">
                <div className="relative">
                  <Link to="/cart">
                    <i className="fa fa-shopping-bag icon icon-circle"></i>
                    <span className="absolute flex top-[-20%] right-[-35%] w-[15px] h-[15px] rounded-full items-center justify-center text-[0.8rem] font-bold text-white bg-black">
                      0
                    </span>
                  </Link>
                </div>
