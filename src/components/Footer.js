...
export default function Footer() {
  ...
  return (
      <footer className="fixed bottom-0 bg-white py-5 w-full flex border-t border-gray-200 justify-center space-x-12 text-gray-400 mt-6">
          ...
          <div onClick={order} className={(path === "/orders" ? 'text-emerald-500 flex justify-center items-center flex-col' : 'flex justify-center items-center flex-col cursor-pointer' )}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
